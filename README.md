...
## Table of Contents
  ...
  * [2. 📋프로젝트 역할 기여](#2-프로젝트-역할-기여)
    ...
    + [2.5. 3D Pose Estimation](#25-3d-pose-estimation)
      - [2.5.1. Pi 카메라 캘리브레이션](#251-pi-카메라-캘리브레이션)
      - [2.5.2. ArUCo 정밀 네비게이션](#252-aruco-정밀-네비게이션)
    + [2.6. Human Following 구현](#26-human-following-구현)
  * [3. ✅필수 조건](#3-필수-조건)
  * [4. ⏩실행 방법](#4-실행-방법)
